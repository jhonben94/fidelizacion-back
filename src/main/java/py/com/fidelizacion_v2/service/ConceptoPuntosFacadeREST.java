 ...
 */
@Stateless
@Path("py.com.fidelizacion_v2.entities.conceptopuntos")
public class ConceptoPuntosFacadeREST extends AbstractFacade<ConceptoPuntos> {

    @PersistenceContext(unitName = "py.com_fidelizacion_v2_war_1.0-SNAPSHOTPU")
    private EntityManager em;

    public ConceptoPuntosFacadeREST() {
